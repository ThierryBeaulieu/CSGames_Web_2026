...
export class EditorTrees implements GameAsset {
...
export class EditorLargeTree extends EditorTrees {
...
export class EditorHighPalm extends EditorTrees {
  constructor(x: number, y: number) {
    const width = 96;
    const height = 239;
...
export class EditorMediumPalm extends EditorTrees {
  constructor(x: number, y: number) {
    const width = 96;
    const height = 188;
